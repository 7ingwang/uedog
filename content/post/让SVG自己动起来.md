...
title: 让 SVG 自己动起来
date: 2022-07-24
hero: /images/svg-demo.png
excerpt: SVG animation with SMIL
...
###### Demo：http://terry.wang/demo/svg-animation-SMIL/

## SMIL是什么？
全称 Synchronized Multimedia Integration Language
SMIL 允许你做这些事情：
...
SMIL 的强大之处在于：不需要 CSS，不需要 JS，只需要 animate 元素即可。重要的是，SMIL 在各大浏览器都支持。

## SMIL Animation 元素及效果概览
`
<set>
<animate>
<animateColor>
...
```
<a href="/svg/svg-animation-demo-set.svg" title="查看实例" target="_blank">查看实例</a>
                    ...
                    <g id="portal/指标管理" transform="translate(247.000000, 165.260000)">
                        ...
                        <g id="Group" transform="translate(1.000000, 0.000000)" fill-rule="nonzero" opacity="0.3">
                            <g id="cube-planet-wall">
                                <polygon id="Path-Copy-2" fill="url(#linearGradient-91q5iw_dy7-4)" points="287.314111 9.61934502e-14 0.574029208 108.977004 8.66088687e-17 263.978596 286.740081 154.986451"></polygon>
